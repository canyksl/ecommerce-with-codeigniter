...
<body class="animsition">
	...
	<header class="header1">
		...
		<div class="container-menu-header">
			<div class="topbar">
				<div class="topbar-social">
					<a href="<?= $config->facebook ?>" class="topbar-social-item fa fa-facebook"></a>
					<a href="<?= $config->instagram ?>" class="topbar-social-item fa fa-instagram"></a>
					
					<a href="<?= $config->twitter ?>" class="topbar-social-item fa fa-twitter"></a>
					<a href="<?= $config->youtube ?>" class="topbar-social-item fa fa-youtube-play"></a>
				</div>
		...
		<div class="wrap_header_mobile">
			<!-- Logo moblie -->
			<a href="<?= base_url('home/index'); ?>" class="logo-mobile">
				<img src="<?= base_url($config->logo) ?>" alt="IMG-LOGO">
			</a>
