...
<head>
  ...
  <title>Eticaret | Admin Paneli</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php  echo base_url('assets/back/');?>index2.html"><b>Eticaret</b>Admin Paneli</a>
  </div>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url('Admin/login');?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" required class="form-control" placeholder="Password" name="sifre">
          <div class="input-group-append">
            <div class="input-group-text">
